 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let sentence=`${me} and ${you} are going to have ${eat} and ${drink} for lunch`;
console.log(sentence)
let sentenceConcat= me+' and '+you+" are going to have "+eat+" and "+ drink+" for lunch"
 ...
 * ↓ YOUR CODE HERE ↓ */
const lunchTime = (foodChoice,drinkChoice) => {return `${me} and ${you} are going to have ${foodChoice} and ${drinkChoice} for lunch`}
console.log(lunchTime('Pizza','Water'))
...
function lunchTime1(foodChoice,drinkChoice){
   return `${me} and ${you} are going to have ${foodChoice} and ${drinkChoice} for lunch`
};
...
console.log(foodForTodayAndTomorrow('ramen','boba',lunchTime('newFoodItem', 'newDrinkItem')))
